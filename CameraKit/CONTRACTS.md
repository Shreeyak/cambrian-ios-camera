...
> Auto-generated by `scripts/regen-contracts.sh` on 2026-04-21 09:24 UTC.
...
| Slug | File:line |
|------|-----------|
| `01:simple-metal-passthrough` | `CameraKit/Sources/CameraKit/MetalPipeline.swift:83` |
...
| `01:skip-completion-guard` | `CameraKit/Sources/CameraKit/MetalPipeline.swift:267` |
| `04:unlocked-uniforms` | `CameraKit/Sources/CameraKit/CameraEngine.swift:376` |
| `04:unlocked-uniforms` | `CameraKit/Sources/CameraKit/CameraEngine.swift:381` |
| `04:unlocked-uniforms` | `CameraKit/Sources/CameraKit/MetalPipeline.swift:102` |
| `04:unlocked-uniforms` | `CameraKit/Sources/CameraKit/MetalPipeline.swift:54` |
