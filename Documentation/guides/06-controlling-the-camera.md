...
chosen at open; see [11-capture-format](11-capture-format.md).
...
`CameraSettings.wbGainB`. For calibration-derived gains, see [08-calibration](08-calibration.md).
...
resolution ([11-capture-format](11-capture-format.md)). The active value is reported as
...
> and can only change by reopening ([11-capture-format](11-capture-format.md)).
...
Processing parameters persist across launches ([07-image-processing](07-image-processing.md));
