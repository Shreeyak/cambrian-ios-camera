...
- `measurements/phase-3-prep/rgba8-conversion.md` — HITL evidence file (Task 10).
...
- **HITL on iPad:** 30 fps sustained at 4K with conversion on; still-capture HDR fidelity unchanged. Evidence path: `measurements/phase-3-prep/rgba8-conversion.md`.
...
**Files:**
- Create: `measurements/phase-3-prep/rgba8-conversion.md`
...
Create `measurements/phase-3-prep/rgba8-conversion.md` capturing:
...
SendUserFile measurements/phase-3-prep/rgba8-conversion.md
```
